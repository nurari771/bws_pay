	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="insertmember.php">
                    ...
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="position" id="position">
						<span class="focus-input100"></span>
						<span class="label-input100">ตำแหน่ง</span>
                    </div>
                    <div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="last_name" id="last_name">
						<span class="focus-input100"></span>
