...
$sql = "SELECT * from ot as t inner join member as m on m.member_id = t.member_id where t.member_id = '".$_SESSION['member_id']."' AND t.ot_id = '".$_GET['ot_id']."'";
...
<!-- Section -->
<section>
<form method="post" name="update_ot.php" id="update_ot.php" action="update_ot.php">
