...
<!-- Section -->
<section>
<form method="POST" action="admin_insertposition.php">
  <div class="form-row">
    <div class="form-group col-md-5">
      <label for="position_id">รหัสตำแหน่ง</label>
      <input type="text" class="form-control" id="position_id" name="position_id" placeholder="รหัสตำแหน่ง" >
    </div>	
  </div>
  <div class="form-row">
    <div class="form-group col-md-5">
	  ...
	  <input class="primary" type="submit" value="บันทึก">
		<input type="reset" value="ยกเลิก" />
				...
				<!-- Sidebar -->
					<div id="sidebar">
						<div class="inner">
							<!-- Search 																																																																														 พงศธร รับผิดชอบbackendหน้านี้
							-->
