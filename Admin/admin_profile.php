<?php 
	...
	// $ot = "SELECT * FROM ot inner join member on ot.member_id = member.member_id ORDER BY ot.ot_id " ;
	// $resultot = mysqli_query($conn,$ot);
	// $countot = mysqli_num_rows($resultot);                                                                                                                                                                                                                                                                                                        ธนสิษฐ์ รับผิดชอบ
?>
<!DOCTYPE HTML>
							...
							<!-- Section -->
								...
								<div class="table-wrapper">
												<table class="alt">
													<thead>
														<tr>
															<td align="right"><a href="admin_addmember.php" class="button primary">เพิ่มข้อมูล</a></td>
														</tr>
													</thead>
												</table>
									  ...
									  <table class="table table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td>
															<a href="admin_see_member.php?member_id=<?php echo $row['member_id']; ?>"><i class="fas fa-eye"></i></a>
													</td>
													<td>
															<a href="admin_editmember.php?member_id=<?php echo $row['member_id']; ?>"><i class="fas fa-pencil-alt" style="font-size: 16px;"></i></a>
													</td>
													<td>
															<a href="admin_deletemember.php?member_id=<?php echo $row['member_id']; ?>"><span class="fas fa-minus" data-toggle="modal" data-target="#exampleModal" ></span>
													</td>
												</tr>
												<?php
														}
