...
<html>
	<head>
		<title>แก้ไขค่าคอมมิชชั่น</title>
		<meta charset="utf-8" />
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<!-- Header -->
								<header id="header">
									<strong>แก้ไขค่าคอมมิชชัน</strong>
									<ul class="icons">
							...
							<!-- Section -->
<section>
<h5 align="center">ใบสำคัญจ่าย</h4><br>
	<form method="post" action="admin_update_com.php">
  ...
  <tr>
	  <div class="form-row">
	      <td align="right"><label for="com_day">ลงวันที่:<font color= red>*</font> </label></td>
				   <td><div class="form-group col-md-7">
	      <input type="date" class="form-control" id="com_day"  name="com_day" value="<?php echo $row['com_day']; ?>"required>
	    </div></td>
		</div>
  </tr>
  ...
  <tr>
    <div class="form-row">
	    <td align="right"><label for="name_project">ชื่อโครงการ:<font color= red>*</font> </label></td>
				<td><div class="form-group col-md-7">
	 	      <input type="text" class="form-control"  id="name_project" name="name_project" value="<?php echo $row['name_project']; ?>"required >
	 	    </div></td>
		</div></tr>
  ...
  <tr>
		<div class="form-row">
		  <td align="right"><label for="total_com">จำนวนเงิน:<font color= red>*</font></label></td>
			 <td><div class="form-group col-md-7">
      <input type="text" class="form-control"  id="total_com"name="total_com" value="<?php echo $row['total_com']; ?>" required>
    </div></td>
	</div></tr>
</tbody>
</table>
<input type="hidden" name="com_id" id="com_id"  value="<?php echo $row['com_id']; ?>">
<input type="hidden" name="confirm" id="confirm"  value="<?php echo $row['confirm']; ?>">
