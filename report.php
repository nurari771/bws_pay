<?php 
	...
	$userCommission = "SELECT * from commission as c inner join member as m on c.member_id = m.member_id where c.member_id = '".$_SESSION['member_id']."'";
	$resultCommission = $conn->query($userCommission);
	$countCommission = mysqli_num_rows($resultCommission);

	$userTravel = "SELECT * from travel as t inner join member as m on t.member_id = m.member_id where t.member_id = '".$_SESSION['member_id']."'";
	...
	$monthCommission = "SELECT * from commission as c inner join member as m on c.member_id = m.member_id where c.member_id = '".$_SESSION['member_id']."' AND MONTH(c.com_day) = '".$month."'";
	...
	$monthTravel = "SELECT * from travel as t inner join member as m on t.member_id = m.member_id where t.member_id = '".$_SESSION['member_id']."' AND MONTH(t.travel_date) = '".$month."'";
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if ($ot_search == 0) {
			...
			$userCommission = "SELECT * from commission as c inner join member as m on c.member_id = m.member_id where c.member_id = '".$_SESSION['member_id']."' AND MONTH(c.com_day) = '".$ot_search."'";
			$resultCommission = $conn->query($userCommission);

			$userTravel = "SELECT * from travel as t inner join member as m on t.member_id = m.member_id where t.member_id = '".$_SESSION['member_id']."' AND MONTH(t.travel_date) = '".$ot_search."'";
			$resultTravel = $conn->query($userTravel);
		}
	}
?>
									  ...
									  <table class="table table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td>
															<a href="see_ot.php?member_id=<?php echo $rowOT['member_id']; ?>&ot_id=<?php echo $rowOT['ot_id']; ?>"><i class="fas fa-eye"></i></a>
													
															<a href="edit_ot.php?member_id=<?php echo $rowOT['member_id']; ?>&ot_id=<?php echo $rowOT['ot_id']; ?>"><i class="fas fa-pencil-alt" style="font-size: 16px;"></i></a>
													
															<a href="deleteot.php?member_id=<?php echo $rowOT['member_id'];?>&ot_id=<?php echo $rowOT['ot_id']; ?>"onClick="javascript:return confirm('คุณต้องการลบข้อมูลใช่หรือไม่');"><span class="fas fa-minus" data-toggle="modal" data-target="#exampleModal" ></span>
													</td>
													<td>
											...
											<tbody>
												...
												<tr>
													...
													<td>
															...
															<a href="see_com.php?member_id=<?php echo $rowCommission['member_id']; ?>&com_id=<?php echo $rowCommission['com_id']; ?>"><i class="fas fa-eye"></i></a>
									  ...
									  <table class="table table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td>
															<a href="see_travel.php?member_id=<?php echo $rowTravel['member_id']; ?>&travel_id=<?php echo $rowTravel['travel_id']; ?>"><i class="fas fa-eye"></i></a>
													
															<a href="edit_travel.php?member_id=<?php echo $rowTravel['member_id']; ?>&travel_id=<?php echo $rowTravel['travel_id']; ?>"><i class="fas fa-pencil-alt" style="font-size: 16px;"></i></a>
													
															<a href="deletetravel.php?member_id=<?php echo $rowTravel['member_id'];?>&travel_id=<?php echo $rowTravel['travel_id']; ?>"onClick="javascript:return confirm('คุณต้องการลบข้อมูลใช่หรือไม่');"><span class="fas fa-minus" data-toggle="modal" data-target="#exampleModal" ></span>
													</td>
											...
											<tfoot>
												<tr>
													...
													<td colspan="3"><?php echo $memberTravel ?> บาท</td>
												</tr>
												<tr>
