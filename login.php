...
<!--=====================================================================================================================================================================================================================================ธนสิษฐ์ พงศธร รับผิดชอบ back end ========================-->
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="check_login.php">
					...
					<div class="wrap-input100 validate-input" >
						...
						<span class="label-input100" required>username</span>
					</div>
				...
				<div class="login100-more" style="background-image: url('images/waterfall.png');">
				</div>
			</div>
		</div>
	</div>
